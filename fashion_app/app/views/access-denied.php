                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="logo text-center">
                            <a href="/"><img src="<?= BASE_URL ?>assets/images/logo/logo-2.png" alt="logo"></a>
                        </div>
                    </div>
                </div>
            </div>
        </header>
        <div class="coming-soon-area bg-img" style="background-image:url(<?= BASE_URL ?>assets/images/bg/bg-3.png);">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="coming-soon-content text-center">
                            <h1 data-aos="fade-up" data-aos-delay="200">Access Denied</h1>
